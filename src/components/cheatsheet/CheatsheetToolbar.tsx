import { RotateCw, RefreshCcwDot } from "lucide-react";
...
export function CheatsheetToolbar({ scope, setScope, onReload, onRestore, language }: Props) {
  ...
  return (
    <div className="flex h-8 shrink-0 items-center justify-between border-b border-zinc-200/80 px-2 dark:border-zinc-800">
      ...
      <div className="flex items-center gap-1">
        <button
          onClick={onReload}
          title={t(language, "cheatsheetReload")}
